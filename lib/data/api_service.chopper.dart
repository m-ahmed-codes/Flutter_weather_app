...
class _$PostApiService extends PostApiService {
  ...
  Future<Response<dynamic>> getPosts({String country = 'london'}) {
    final Uri $url = Uri.parse(
        'https://api.weatherapi.com/v1/forecast.json?key=0fd88b9df21f4a5a9b7161254242009&q=london&days=2&aqi=yes&alerts=no/forecast.json?key=0fd88b9df21f4a5a9b7161254242009');
